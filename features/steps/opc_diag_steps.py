...
def step_then_pkg_appears_in_target_dir(context: Context):
    ...
    expected_sha1_list = [
        ...
        ("585be5da0832f70b4e71f66f5784cc8acbcc8e88", "docProps/thumbnail.jpeg"),
        ("85ff3c93403fee9d07d1f52b08e03e1ad8614343", "ppt/_rels/presentation.xml.rels"),
    ...
    assertManifestsMatch(actual_manifest, expected_manifest, "actual", "expected")
